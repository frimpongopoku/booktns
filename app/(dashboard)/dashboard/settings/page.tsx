...
import { serializeVendor, serializeVendorVideo, serializeService } from "@/lib/serialize";
...
export default async function SettingsPage() {
  ...
  const [vendor, businessHours, videos, services, verificationApplication] = await Promise.all([
