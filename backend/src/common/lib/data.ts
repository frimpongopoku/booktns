...
export const videos: VendorVideo[] = [
  ...
  },
  {
    id: "vid2",
    vendorId: "v1",
    title: "Studio Tour — Glam by Akosua",
    description: "A look inside our space in East Legon.",
    durationSeconds: 62,
    gradientFrom: "#18181B",
    gradientTo: "#C0283A",
