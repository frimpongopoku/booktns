...
export const getStorefrontVendor = (async (slug: string): Promise<StorefrontVendor | null> => {
...
export const getStorefrontVendorForPreview = (async (slug: string): Promise<StorefrontVendor | null> => {
...
// misleading.
export const getVendorPublicMeta = (async (slug: string): Promise<VendorPublicMeta | null> => {
  const vendor = await db.vendor.findUnique({
...
// needs no session.
export const getVendorIconLogoUrl = (async (slug: string): Promise<string | null> => {
  const vendor = await db.vendor.findUnique({
