...
export const updateVendorSchema = z
  .object({
    ...
    galleryImageUrls: z.array(z.string().trim().url()).max(24, "Up to 24 photos in your gallery").optional(),
    galleryTitle: z.string().trim().max(60, "Keep the title under 60 characters").nullable().optional(),
    galleryDescription: z.string().trim().max(160, "Keep the description under 160 characters").nullable().optional(),
