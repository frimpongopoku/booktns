...
function StorefrontTab({ businessHours }: StorefrontTabProps) {
...
export default function SettingsClient({ businessHours }: SettingsClientProps) {
  ...
  return (
    <div>
      ...
      {tab === "storefront" && <StorefrontTab businessHours={businessHours} />}
